...
class ModtranTest(unittest.TestCase):
    ...
    def test_modtran_run(self):
        """
        Test to run modtran 6.0.1 program and check transmittance
        parameter generated is correct
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertIsNone(pd.testing.assert_frame_equal(df,nbar,check_less_precise=True))
